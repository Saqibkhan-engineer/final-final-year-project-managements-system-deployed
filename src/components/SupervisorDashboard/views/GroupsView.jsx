...
export function GroupsView({
  ...
  return (
    <div className="section-card">
      <h2 className="section-title">👥 My Assigned Groups</h2>
            ...
            return (
              <div key={gId} className="group-card">
                <div className="group-card-header">
                  ...
                  <button className="btn-primary" onClick={() => handleOpenEvaluate(gId, 'supervisor')} style={{ padding: '0.4rem 0.8rem', fontSize: '0.8rem' }}>
                    ✅ Evaluate
                  </button>
                </div>
