...
import { Users, Lightbulb, FileText, Scale, Inbox, BarChart, CheckCircle } from "lucide-react";
  ...
  return (
    <div className="dashboard-home">
      <div className="welcome-banner" style={{ background: "linear-gradient(135deg, #4f46e5 0%, #3b82f6 100%)" }}>
        <h1>Welcome, {user?.name || "Supervisor"}!</h1>
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card" style={{ borderTop: "4px solid #10b981" }}>
          <div className="stat-icon" style={{ background: "#ecfdf5", color: "#10b981" }}><Lightbulb size={24} /></div>
          <div className="stat-info">
            <h3>Your Ideas</h3>
        ...
        <div className="stat-card" style={{ borderTop: "4px solid #f59e0b" }}>
          <div className="stat-icon" style={{ background: "#fffbeb", color: "#f59e0b" }}><FileText size={24} /></div>
          <div className="stat-info">
        ...
        <div className="stat-card" style={{ borderTop: "4px solid #8b5cf6" }}>
          <div className="stat-icon" style={{ background: "#f5f3ff", color: "#8b5cf6" }}><Scale size={24} /></div>
          <div className="stat-info">
      ...
      <div className="recent-activity">
        ...
        <div className="activity-list" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1rem" }}>
          <div className="activity-item" style={{ background: "#f8fafc", padding: "1.25rem", borderRadius: "12px", border: "1px solid #e2e8f0" }}>
            <h4 style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><Inbox size={18} /> Check Requests</h4>
            <p style={{ fontSize: "0.85rem", color: "#64748b", margin: "5px 0" }}>Review new group formation requests from students.</p>
          </div>
          <div className="activity-item" style={{ background: "#f8fafc", padding: "1.25rem", borderRadius: "12px", border: "1px solid #e2e8f0" }}>
            <h4 style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><BarChart size={18} /> Monitor Progress</h4>
            <p style={{ fontSize: "0.85rem", color: "#64748b", margin: "5px 0" }}>View GitHub analytics and commit history for your groups.</p>
          </div>
          <div className="activity-item" style={{ background: "#f8fafc", padding: "1.25rem", borderRadius: "12px", border: "1px solid #e2e8f0" }}>
            <h4 style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><CheckCircle size={18} /> Evaluate Phases</h4>
